...
export function getAuthHash(master_key: string, salt: string): string {
 ...
 */
export async function login(email: string, password: string, router: Router, setErrorMessage: ((message: string) => void) | null) {
  try {
